...
function forId(clickedId) {
  ...
  var taskDetails =
    ...
    "<label  for='taskName'  class='toShow col-form-label col-sm-3'>" +
    getTasks[theId].name +
    '</label>' +
    "<div class='col-sm-3'>" +
    "<input type='text' class='toHide form-control' id='taskName' value=' " +
    getTasks[theId].name +
    " '>" +
    '</div>' +
    '</div>' +
    ...
    "<label  for='taskDesc'  class='toShow col-form-label col-sm-3'>" +
    getTasks[theId].description +
    '</label>' +
    "<div class='col-sm-3'>" +
    "<input type='text' class='toHide form-control' id='taskDesc' value='" +
    getTasks[theId].description +
    "'>" +
    '</div>' +
    '</div>' +
    ...
    "<label  for='taskType'  class='toShow col-form-label col-sm-3'>" +
    getTasks[theId].type +
    '</label>' +
    "<div class='col-sm-3'>" +
    "<input type='text' class='toHide form-control' id='taskType' value=' " +
    getTasks[theId].type +
    "'>" +
    '</div>' +
    '</div>' +
    ...
    "<label  for='taskStatus'  class='toShow col-form-label col-sm-3'>" +
    getTasks[theId].status +
    '</label>' +
    "<div class='col-sm-3'>" +
    "<input type='text' class='toHide form-control' id='taskStatus' value=' " +
    getTasks[theId].status +
    "'>" +
    '</div>' +
    '</div>' +
    ...
    "<label  for='taskPName'  class='toShow col-form-label col-sm-3'>" +
    getTasks[theId].projectname +
    '</label>' +
    "<div class='col-sm-3'>" +
    "<input type='text' class='toHide form-control' id='taskPName' value=' " +
    getTasks[theId].projectname +
    "'>" +
    '</div>' +
    '</div>' +
    ...
    "<label  for='taskATo' class='toShow col-form-label col-sm-3'>" +
    getTasks[theId].assignedTo +
    '</label>' +
    "<div class='col-sm-3'>" +
    "<input type='text' class='toHide form-control' id='taskATo' value=' " +
    getTasks[theId].assignedTo +
    "'>" +
    '</div>' +
    '</div>' +
    ...
    "<label  for='taskOrighrs' class='toShow col-form-label col-sm-3'>" +
    getTasks[theId].orighrs +
    '</label>' +
    "<div class='col-sm-3'>" +
    "<input type='text' class='toHide form-control' id='taskOrighrs' value=' " +
    getTasks[theId].orighrs +
    "'>" +
    '</div>' +
    '</div>' +
    ...
    "<label  for='taskWrkhrs' class='toShow col-form-label col-sm-3'>" +
    getTasks[theId].workedhrs +
    '</label>' +
    "<div class='col-sm-3'>" +
    "<input type='text' class='toHide form-control' id='taskWrkhrs' value=' " +
    getTasks[theId].workedhrs +
    "'>" +
    '</div>' +
    '</div>' +
    ...
    "<label  for='taskRmhrs' class='toShow col-form-label col-sm-3'>" +
    getTasks[theId].orighrs +
    '</label>' +
    "<div class='col-sm-3'>" +
    "<input type='text' class='toHide form-control' id='taskRmhrs' value=' " +
    getTasks[theId].orighrs +
    "'>" +
    '</div>' +
    '</div>' +
    ...
    "<label  for='taskPdate' class='toShow col-form-label col-sm-3'>" +
    getTasks[theId].date +
    '</label>' +
    "<div class='col-sm-3'>" +
    "<input type='text' class='toHide form-control' id='taskPdate' value=' " +
    getTasks[theId].date +
    "'>" +
    '</div>' +
    '</div>' +
    ...
    "<label  for='taskCdate' class='toShow col-form-label col-sm-3'>" +
    getTasks[theId].date +
    '</label>' +
    "<div class='col-sm-3'>" +
    "<input type='text' class='toHide form-control' id='taskCdate' value=' " +
    getTasks[theId].date +
    "'>" +
    '</div>' +
    '</div>' +
